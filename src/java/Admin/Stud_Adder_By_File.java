 ...
 * @author venishetty
 */
public class Stud_Adder_By_File extends HttpServlet {
        ...
        try {
           ...
           boolean isMultipart = ServletFileUpload.isMultipartContent(request);
            ...
            if (isMultipart) {
                    ...
                    else
                    {
                        try {
                            ...
                            if (ext.equals("txt") || ext.equals("text"))
                            {
                             ...
                             try {
                del(new File(path));  // deletes all docs in this paper id
            } catch (IOException e) {
                e.printStackTrace();
                System.exit(0);
            }
                ...
                Iterator studList_it = studList.iterator();

                while(studList_it.hasNext()) {
                    String studInfo[] = ((String)studList_it.next()).split(",");
                    int rollNo = Integer.parseInt(studInfo[0]);
                    String name = studInfo[1];
                    String webmail = studInfo[2];
                    m.addStudent(rollNo,name,webmail);
                }
